...
(async () => {
  ...
  // Launch Chrome with the user's profile using channel=chrome
  const tmpDir = '/var/folders/h4/3th_wwt10h306qy1rs34zd3m0000gr/T/tmp.1ZiRxQaP';
  ...
  if (currentUrl.includes('sign-in') || currentUrl.includes('login')) {
    console.log('ERROR: Not logged in to Substack. Cookie copy did not work.');
  ...
  if (!titleEl) {
    console.log('Could not find title editor.');
  ...
  console.log('Found editor. Filling title...');
  ...
  let continueButton = await page.$('button:has-text("Continuer")') || 
