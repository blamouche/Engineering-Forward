...
TODO = ROOT / '.prompt-hub/todo/todo-20260419-150402-scan-list.md'
SCRIPT = ROOT / '.prompt-hub/todo/scan_list_20260419-150402_runner.py'
...
def main() -> None:
    ...
    append_memory(f'Created and verified batch recap `{RECAP.relative_to(ROOT)}` after processing {len(processed)} URL(s) with {len(errors)} error(s).', f'`{RECAP.relative_to(ROOT)}`, `.prompt-hub/todo/todo-20260419-150402-scan-list.md`, `.prompt-hub/version.md`, `.prompt-hub/releases.md`', 'success', 'Commit recap changes, then push all local commits.')
